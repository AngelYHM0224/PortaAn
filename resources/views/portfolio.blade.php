<x-main-layout>
    ...
    <div class="relative bg-white overflow-hidden bg-gray-800">
                                ...
                                <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                                    <div class="flex items-center justify-between w-full md:w-auto">
                                        <a href="#">
                                            ...
                                            {{-- Icono --}}
                                            <img alt="Workflow" class="h-10 w-auto sm:h-12" src="{{ asset('/image/programacion1.jpg') }}">
                                        </a>
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-80 w-full object-cover sm:h-96 md:h-full lg:w-full lg:h-full" src="{{ asset('/image/programacion1.jpg') }}" alt="Dafault Hero img">
        </div>
    </div>
